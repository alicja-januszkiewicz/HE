...
def test_cube_round():
    ...
    b = Cube(1.0, -1.0, 0.0)
    c = Cube(0.0, -1.0, 1.0)
    equal_cube("hex_round 1", Cube(5, -10, 5), cube_round(cube_lerp(Cube(0.0, 0.0, 0.0), Cube(10.0, -20.0, 10.0), 0.5)))
    equal_cube("hex_round 2", cube_round(a), cube_round(cube_lerp(a, b, 0.499)))
    equal_cube("hex_round 3", cube_round(b), cube_round(cube_lerp(a, b, 0.501)))
    equal_cube("hex_round 4", cube_round(a), cube_round(Cube(a.q * 0.4 + b.q * 0.3 + c.q * 0.3, a.r * 0.4 + b.r * 0.3 + c.r * 0.3, a.s * 0.4 + b.s * 0.3 + c.s * 0.3)))
    equal_cube("hex_round 5", cube_round(c), cube_round(Cube(a.q * 0.3 + b.q * 0.3 + c.q * 0.4, a.r * 0.3 + b.r * 0.3 + c.r * 0.4, a.s * 0.3 + b.s * 0.3 + c.s * 0.4)))
